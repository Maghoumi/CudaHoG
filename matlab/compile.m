...
% clc
% % !nvcc -O0 -std=c++11 -c CudaBoxFilter.cu -Xcompiler -fPIC -I/usr/local/MATLAB/R2014a/extern/include -I/usr/local/MATLAB/R2014a/toolbox/distcomp/gpu/extern/include
% % % mex -largeArrayDims CudaBoxFilter.o -L/usr/local/cuda/lib64 -L/usr/local/MATLAB/R2014a/bin/glnxa64 -L./ -lcudart -lCudaHoG
