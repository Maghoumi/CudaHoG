...
public:
	...
	static CudaMemory<Npp32f> getCentralDifferenceKernelX();
	static CudaMemory<Npp32f> getCentralDifferenceKernelY();

	static CudaMemory<Npp32f> getBoxKernel(const int size);
